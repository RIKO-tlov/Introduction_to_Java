...
public class Wizard {
  ...
  public void heal(Hero h) {
    ...
    int recovPoint = (int)(basePoint * this.getWand().gePower());   //杖による増幅
...
/*13-2
内容：Wizardクラスで「powerはWandでprivateアクセスされます」
原因：Wandクラスのpowerフィールドはprivate修飾されているので、Wizardクラスから直接アクセスできないため。
*/
